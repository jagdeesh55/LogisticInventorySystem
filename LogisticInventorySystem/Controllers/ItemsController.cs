...
namespace LogisticInventorySystem.Views.Items
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Mame,Description,Quantity")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Mame,Description,Quantity")] Item item)
        {
            if (id != item.ID)
            {
                return NotFound();
